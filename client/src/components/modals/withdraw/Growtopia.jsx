  ...
  return (
    <Box className={classes.root}>
      <Fragment>
        ...
        <li>
          Wait for the loading to complete &#40;it may take up to 30
          seconds&#41;.
        </li>
        ...
        <li>
          ...
          <img
            src="https://growdice.co/assets/wl-b3d08b52.webp"
            width="18"
            height="18"
            alt=""
          ...
          /{" "}
          <img
            src="https://growdice.co/assets/bgl-e2c76d7e.webp"
            width="18"
            height="18"
            alt=""
            className="sc-x7t9ms-0 dnLnNz"
        ...
        <li>
          ...
          <a target="_blank" className="text-white" href="/discord">
            support
          </a>
          .
        </li>
